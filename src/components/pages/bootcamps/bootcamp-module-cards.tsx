...
export default function BootcampModuleCards({
  ...
  const hasCurrentSlug = !!currentSlug;
  ...
  return (
    <section
      ...
      className={contained
        ? "py-14 md:py-20 scroll-mt-[96px]"
        : "bg-[hsl(var(--bg-primary-50))] pt-0 pb-12 md:pb-16 scroll-mt-[96px]"
      }
    >
      <div className="container-default">
        ...
        <div className={`grid grid-cols-1 gap-6 ${
          hasCurrentSlug || (!contained) ? "md:grid-cols-3 md:gap-5 lg:gap-7" : "md:grid-cols-2 md:gap-5"
        }`}>
          {modules.map((mod) => (
            <BootcampCard
              key={mod.slug}
