...
function ArticleCard({ article }: { article: Article }) {
  return (
    <Link href={article.href} className="block w-full group">
      <article className="flex flex-col md:flex-row gap-6 p-5 md:h-[280px] transition-all duration-300 bg-card rounded-[calc(var(--radius)+6px)] border border-transparent hover:border-accent/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
        {/* ── Content (left) ── */}
...
export default function ArticlesPreviewSection() {
  return (
    <section className="w-full py-16 lg:py-20 px-4 flex flex-col gap-9 items-center bg-[hsl(var(--sidebar))]">
      {/* ── Header ── */}
