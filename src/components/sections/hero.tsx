...
const stats = [
  { value: "12k+", label: "Product Designers", hasStars: false },
  { value: "4.98/5", label: "Positive Reviews", hasStars: true },
  { value: "100%", label: "Money Back Guarantee", hasStars: false },
];

function StarIcon() {
  return (
    <svg className="h-4 w-4 fill-[#F59E0B]" viewBox="0 0 20 20">
  ...
  return (
    <section className="bg-[#f8f7f4] pt-32 pb-16 md:pb-24 overflow-hidden">
      <div className="container-default">
        ...
        {/* Stats bar */}
        <div className="mt-12 mx-auto max-w-[750px]">
              ...
              <div
                ...
                className={`text-center py-4 sm:py-0 ${
                  index < stats.length - 1
                    ? "sm:border-r sm:border-[#dfdbc9]"
                    : ""
                } ${index > 0 ? "border-t sm:border-t-0 border-[#dfdbc9]" : ""}`}
              >
                <p className="text-3xl md:text-4xl font-black text-[#1a2130]">
                  {stat.value}
                </p>
                {stat.hasStars && (
                ...
                <p className="text-[11px] md:text-[12px] font-bold text-[#99825d] uppercase tracking-widest mt-1">
                  {stat.label}
                </p>
              </div>
            ))}
