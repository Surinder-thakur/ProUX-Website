/* =============================================================================
 * DESIGNERS: Auth Layout
 * =============================================================================
 * Centered layout for login/signup pages without the main header and footer.
 * Uses a split design with brand accent on the left and form on the right.
 *
 * To update:
 * - Change the brand accent panel background via bg-proux-navy
 * - Update the tagline and visual elements in the left panel
 * - Adjust form container width via max-w classes
 * ========================================================================== */
...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen">
      {/* ── DESIGNERS: Brand Accent Panel (desktop only) ────────────── */}
      {/* Hidden on mobile, visible on lg+ screens */}
      <div className="hidden lg:flex lg:w-1/2 bg-proux-navy relative overflow-hidden">
        <div className="flex flex-col justify-center px-16 text-white relative z-10">
          {/* ProUX Logo Mark */}
          <svg
            className="mb-10 h-10 w-auto self-start"
            fill="none"
            viewBox="0 0 132 22"
          >
            <g clipPath="url(#clip_auth_logo)">
              <path
          ...
          <p className="text-white/70 text-lg leading-relaxed">
            Expert UX consulting, professional training courses, and powerful
            AI-first design tools — all in one platform.
          </p>

          {/* DESIGNERS: Decorative background element */}
