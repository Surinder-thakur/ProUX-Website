 ...
 * Submits via Supabase Auth to create a new account.
 *
 * To update:
  ...
  if (success) {
    return (
      <div className="text-center">
        {/* DESIGNERS: Success checkmark icon */}
        ...
        <h2 className="heading-2 text-proux-navy mb-3">Check your email</h2>
    ...
    <div>
      ...
      <div className="mb-8 lg:hidden">
        <svg
          ...
          viewBox="0 0 132 22"
        >
          <g clipPath="url(#clip_signup_logo)">
            <path
      ...
      {/* DESIGNERS: Signup form heading */}
      <div className="mb-8">
        <h1 className="heading-2 text-proux-navy mb-2">Create your account</h1>
        <p className="body-base">
          Start your free trial and unlock AI-first UX tools, courses, and
          resources.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* DESIGNERS: Confirm password field */}
        <div className="space-y-2">
